...
# -------------------------------------------------------------
#Otsu's Binarization 
imgN = cv.imread('noisy2.png',0)

# global thresholding
ret1,thr1 = cv.threshold(imgN,127,255,cv.THRESH_BINARY)

# Otsu's thresholding
ret2,thr2 = cv.threshold(imgN,0,255,cv.THRESH_BINARY+cv.THRESH_OTSU)

# Otsu's thresholding after Gaussian filtering
blur = cv.GaussianBlur(imgN,(5,5),0)
