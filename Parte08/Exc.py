...
c_path = 'images/marvao/1.png'

ic_path = 'images/marvao/2.png'


# taking the image in grayscale format
correct_img = cv2.imread(c_path, cv2.IMREAD_GRAYSCALE)
incorrect_img = cv2.imread(ic_path, cv2.IMREAD_GRAYSCALE)
...
while True:
    ...
    cv2.resizeWindow("Destination Image", 600, 400)
    cv2.imshow("Destination Image",correct_img)

    cv2.namedWindow("Source Image", cv2.WINDOW_NORMAL)
    cv2.resizeWindow("Source Image", 600, 400)
    cv2.imshow("Source Image",incorrect_img)

    cv2.namedWindow("Destination Image Keypoints", cv2.WINDOW_NORMAL)
    cv2.resizeWindow("Destination Image Keypoints", 600, 400)
    cv2.imshow("Destination Image Keypoints",correct_img_keypoints)

    cv2.namedWindow("Source Image Keypoints", cv2.WINDOW_NORMAL)
    cv2.resizeWindow("Source Image Keypoints", 600, 400)
...
while True:
    ...
    cv2.resizeWindow("Warped Source Image", 600, 400)
