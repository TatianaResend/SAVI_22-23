...
def main():
    ...
    planes = []
    while True: # run consecutives plane detections
    
        plane = Plane_detection(point_cloud) # create a new plane instance
        point_cloud = plane.segment()   # new point cloud are the outliers of this plane detection
        print(plane)

        plane.inlier_cloud.paint_uniform_color([1.0, 1.0, 0])
